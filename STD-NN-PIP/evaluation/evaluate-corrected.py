...
input_data = np.genfromtxt('input_for_neural_new.txt', delimiter=',')
...
indices_for_test = np.genfromtxt(paths + 'test_indices.txt').astype(int)
test_indices = indices_for_test
indices_for_all = np.genfromtxt(paths + 'indices_for_neural.txt').astype(int)

#test_indices = np.genfromtxt('../data_preprocessing/Init_Cond/test_indices.txt')
#test_indices = np.genfromtxt('test.dat')
...
#indices_for_neural = np.genfromtxt('indices_for_neural.txt').astype(int)

mval_input = np.loadtxt(paths + 'Coeff_mval_input.txt', delimiter=',', unpack=True)
stdv_input = np.loadtxt(paths + 'Coeff_stdv_input.txt', delimiter=',', unpack=True)
mval_output = np.loadtxt(paths + 'Coeff_mval_output.txt', delimiter=',', unpack=True)
stdv_output = np.loadtxt(paths + 'Coeff_stdv_output.txt', delimiter=',', unpack=True)
# Import optimized NN weights and biases

h0W = np.loadtxt(paths + 'Coeff_h0W.dat', delimiter=',', unpack=True)
h0b = np.loadtxt(paths + 'Coeff_h0b.dat', delimiter=',', unpack=True)
h1W = np.loadtxt(paths + 'Coeff_h1W.dat', delimiter=',', unpack=True)
h1b = np.loadtxt(paths + 'Coeff_h1b.dat', delimiter=',', unpack=True)
h2W = np.loadtxt(paths + 'Coeff_h2W.dat', delimiter=',', unpack=True)
h2b = np.loadtxt(paths + 'Coeff_h2b.dat', delimiter=',', unpack=True)
h3W = np.loadtxt(paths + 'Coeff_h3W.dat', delimiter=',', unpack=True)
h3b = np.loadtxt(paths + 'Coeff_h3b.dat', delimiter=',', unpack=True)
h4W = np.loadtxt(paths + 'Coeff_h4W.dat', delimiter=',', unpack=True)
h4b = np.loadtxt(paths + 'Coeff_h4b.dat', delimiter=',', unpack=True)
h5W = np.loadtxt(paths + 'Coeff_h5W.dat', delimiter=',', unpack=True)
h5b = np.loadtxt(paths + 'Coeff_h5b.dat', delimiter=',', unpack=True)
h6W = np.loadtxt(paths + 'Coeff_h6W.dat', delimiter=',', unpack=True)
h6b = np.loadtxt(paths + 'Coeff_h6b.dat', delimiter=',', unpack=True)
h7W = np.loadtxt(paths + 'Coeff_h7W.dat', delimiter=',', unpack=True)
h7b = np.loadtxt(paths + 'Coeff_h7b.dat', delimiter=',', unpack=True)
h8W = np.loadtxt(paths + 'Coeff_h8W.dat', delimiter=',', unpack=True)
h8b = np.loadtxt(paths + 'Coeff_h8b.dat', delimiter=',', unpack=True)
h9W = np.loadtxt(paths + 'Coeff_h9W.dat', delimiter=',', unpack=True)
h9b = np.loadtxt(paths + 'Coeff_h9b.dat', delimiter=',', unpack=True)
h10W = np.loadtxt(paths + 'Coeff_h10W.dat', delimiter=',', unpack=True)
h10b = np.loadtxt(paths + 'Coeff_h10b.dat', delimiter=',', unpack=True)
h11W = np.loadtxt(paths + 'Coeff_h11W.dat', delimiter=',', unpack=True)
h11b = np.loadtxt(paths + 'Coeff_h11b.dat', delimiter=',', unpack=True)
h12W = np.loadtxt(paths + 'Coeff_h12W.dat', delimiter=',', unpack=True)
h12b = np.loadtxt(paths + 'Coeff_h12b.dat', delimiter=',', unpack=True)
h13W = np.loadtxt(paths + 'Coeff_h13W.dat', delimiter=',', unpack=True)
h13b = np.loadtxt(paths + 'Coeff_h13b.dat', delimiter=',', unpack=True)
h14W = np.loadtxt(paths + 'Coeff_h14W.dat', delimiter=',', unpack=True)
h14b = np.loadtxt(paths + 'Coeff_h14b.dat', delimiter=',', unpack=True)
h15W = np.loadtxt(paths + 'Coeff_h15W.dat', delimiter=',', unpack=True)
h15b = np.loadtxt(paths + 'Coeff_h15b.dat', delimiter=',', unpack=True)
h16W = np.loadtxt(paths + 'Coeff_h16W.dat', delimiter=',', unpack=True)
h16b = np.loadtxt(paths + 'Coeff_h16b.dat', delimiter=',', unpack=True)
h17W = np.loadtxt(paths + 'Coeff_h17W.dat', delimiter=',', unpack=True)
h17b = np.loadtxt(paths + 'Coeff_h17b.dat', delimiter=',', unpack=True)
# h18W = np.loadtxt(paths + 'Coeff_h18W.dat', delimiter=',', unpack=True)
# h18b = np.loadtxt(paths + 'Coeff_h18b.dat', delimiter=',', unpack=True)
# h19W = np.loadtxt(paths + 'Coeff_h19W.dat', delimiter=',', unpack=True)
# h19b = np.loadtxt(paths + 'Coeff_h19b.dat', delimiter=',', unpack=True)
# h20W = np.loadtxt(paths + 'Coeff_h20W.dat', delimiter=',', unpack=True)
# h20b = np.loadtxt(paths + 'Coeff_h20b.dat', delimiter=',', unpack=True)
outW = np.loadtxt(paths + 'Coeff_outW.dat', delimiter=',', unpack=True)
outb = np.loadtxt(paths + 'Coeff_outb.dat', delimiter=',', unpack=True)
...
#    i = i+1
    ...
    if non_stand_features[0] != 20.0:
        ...
        E, p = np.loadtxt(path + 'pevj' + str(indices_for_all[i]+1) + '.dat', unpack=True)
    ...
    if performance_evaluation:
        ...
        if external_plotting:
            ...
            with open("./external_plotting/NN_pe" + str(indices_for_all[i]+1) + "_NN.txt", "w") as txt_file:
                for j in range(len(grid)):
                    txt_file.write(str(grid[j]) + ' ' + str(p_pred_perf[j]) + '\n')

            with open("./external_plotting/NN_pe" + str(indices_for_all[i]+1) + "_InputPoints.txt", "w") as txt_file:
                for j in range(len(grid)):
    ...
    ##########################################################################################################
        ...
        E, p = np.loadtxt(path + 'pv' + str(indices_for_all[i]+1) + '.dat', unpack=True)
    ...
    if performance_evaluation:
        ...
        if external_plotting:
            ...
            with open("./external_plotting/NN_pv" + str(indices_for_all[i]+1) + "_NN.txt", "w") as txt_file:
                for j in range(len(grid)):
                    txt_file.write(str(grid[j]) + ' ' + str(p_pred_perf[j]) + '\n')

            with open("./external_plotting/NN_pv" + str(indices_for_all[i]+1) + "_InputPoints.txt", "w") as txt_file:
                for j in range(len(grid)):
                    txt_file.write(str(grid[j]) + ' ' + str(p_true_perf[j]) + '\n')
    ...
    #######################################################################################################
        ...
        E, p = np.loadtxt(path + 'pj' + str(indices_for_all[i]+1) + '.dat', unpack=True)
    ...
    if performance_evaluation:
        ...
        if external_plotting:
            ...
            with open("./external_plotting/NN_pj" + str(indices_for_all[i]+1) + "_NN.txt", "w") as txt_file:
                for j in range(len(grid)):
                    txt_file.write(str(grid[j]) + ' ' + str(p_pred_perf[j]) + '\n')

            with open("./external_plotting/NN_pj" + str(indices_for_all[i]+1) + "_InputPoints.txt", "w") as txt_file:
                for j in range(len(grid)):
                    txt_file.write(str(grid[j]) + ' ' + str(p_true_perf[j]) + '\n')
        ...
        if external_plotting:
            ...
            with open("./external_plotting/NN" + str(indices_for_all[i]+1) + "_general.txt", "w") as txt_file:
                txt_file.write(str(indices_for_all[i]+1) + ' ' + 'E_trans:' + str(non_stand_features[0]) + ', v_in:' + str(
                    non_stand_features[1]) + ', j_in:' + str(non_stand_features[2]) + ', R2:' + str(R2over) + ', RMSD:' + str(RMSDover) + ', NN_Integral: ' + str(newv) + ', MaxPv: ' + str(maxpvalue) +   '\n')
