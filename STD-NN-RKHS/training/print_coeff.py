...
model_parameter_save = "save/321900-222222666666999999111111111133133133161161161_loss0.23222958_2024-04-17-11-01-20-257"
# number of input variables
n_inputs = data.num_features
# number of neurons in each hidden layer (and how many hidden layers)
n_hidden = [22, 22, 22, 66, 66, 66, 99, 99, 99, 111, 111, 111, 133, 133, 133, 161, 161, 161]
# n_hidden = [59,59]
# n_hidden = [56,56]
...
l2_lambda = 1e-4  # default value I use is 1e-4!
