...
input_data = np.genfromtxt('../training/input_for_neural_new.txt', delimiter=',')
...
test_indices = np.genfromtxt('../training/test_indices.txt')
test_indices = test_indices.astype(int)
#print(str(test_indices)) # print the indices of your data
indices_for_neural = np.genfromtxt('../training/indices_for_neural.txt').astype(int)
...
for i in test_indices:
    ...
    print('Current data set: ' + str(indices_for_neural[i]+1) + '\n')
    ...
    if non_stand_features[0] != 20.0:
        ...
        E, p = np.loadtxt(path2 + 'pevj' + str(indices_for_neural[i]+1) + '.dat', unpack=True)
    ...
    if performance_evaluation:
        ...
        if external_plotting:
            ...
            with open("./external_plotting/NN_pe" + str(indices_for_neural[i]+1) + "_NN.txt", "w") as txt_file:
                for j in range(len(grid)):
                    txt_file.write(str(grid[j]) + ' ' + str(p_pred_perf[j]) + '\n')

            with open("./external_plotting/NN_pe" + str(indices_for_neural[i]+1) + "_InputPoints.txt", "w") as txt_file:
                for j in range(len(grid)):
    ...
    ##########################################################################################################
        ...
        E, p = np.loadtxt(path2 + 'pv' + str(indices_for_neural[i]+1) + '.dat', unpack=True)
    ...
    if performance_evaluation:
        ...
        if external_plotting:
            ...
            with open("./external_plotting/NN_pv" + str(indices_for_neural[i]+1) + "_NN.txt", "w") as txt_file:
                for j in range(len(grid)):
                    txt_file.write(str(grid[j]) + ' ' + str(p_pred_perf[j]) + '\n')

            with open("./external_plotting/NN_pv" + str(indices_for_neural[i]+1) + "_InputPoints.txt", "w") as txt_file:
                for j in range(len(grid)):
                    txt_file.write(str(grid[j]) + ' ' + str(p_true_perf[j]) + '\n')
    ...
    #######################################################################################################
        ...
        E, p = np.loadtxt(path2 + 'pj' + str(indices_for_neural[i]+1) + '.dat', unpack=True)
    ...
    if performance_evaluation:
        ...
        if external_plotting:
            ...
            with open("./external_plotting/NN_pj" + str(indices_for_neural[i]+1) + "_NN.txt", "w") as txt_file:
                for j in range(len(grid)):
                    txt_file.write(str(grid[j]) + ' ' + str(p_pred_perf[j]) + '\n')

            with open("./external_plotting/NN_pj" + str(indices_for_neural[i]+1) + "_InputPoints.txt", "w") as txt_file:
                for j in range(len(grid)):
                    txt_file.write(str(grid[j]) + ' ' + str(p_true_perf[j]) + '\n')
        ...
        if external_plotting:
            ...
            with open("./external_plotting/NN" + str(indices_for_neural[i]+1) + "_general.txt", "w") as txt_file:
                txt_file.write(str(indices_for_neural[i]+1) + ' ' + 'E_trans:' + str(non_stand_features[0]) + ', v_in:' + str(
...
if performance_evaluation:
    ...
    with open("./performance_R2.txt", "w") as txt_file:
        ...
        print(x)
        txt_file.write('Best Dataset: ' + str(x)+'\n')
        txt_file.write('Best: ' + str(1.0-R2_each[0])+'\n')

        print('Worst: ')
        x = np.where(R2_unsorted == R2_each[len(R2_each)-1])
        print(x)
        txt_file.write('Worst Dataset: ' + str(x)+'\n')
        txt_file.write('Worst: ' + str(1.0-R2_each[len(R2_each)-1])+'\n')

        print('Middle: ')
        mean = np.mean(R2_each)
        x = find_nearest(R2_unsorted, mean)
        txt_file.write('Representative Dataset : ' + str(x) + '\n')
        txt_file.write('Representative: ' + str(1.0-R2_unsorted[x])+'\n')
